...
const MODELS = [
  ...
  m("alibaba/qwen3.7-plus","阿里","Qwen3.7-Plus","domestic",2.0,8.0,null,1048576,131072,true,true,false,false,false,"2026-07","中端。≤256K¥2/8,>256K跳涨。","confirmed","https://help.aliyun.com/zh/model-studio/getting-started/models",null,null,null),
  ...
  m("minimax/m3","MiniMax","MiniMax M3","domestic",2.10,8.40,0.42,512000,16384,true,true,true,false,false,"2026-Q1","标准≤512K¥2.1/8.4。SWE-bench Pro59.0,GPQA Diamond~90,AA综合54.7。","confirmed","https://platform.minimaxi.com/docs/guides/pricing-paygo",74,90,"https://codingfleet.com/blog/minimax-m3-vs-deepseek-v4-pro-the-open-weight-chinese-ai-showdown/"),
